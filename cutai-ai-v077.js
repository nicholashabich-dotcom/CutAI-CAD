...
const ALLOWED=new Set(["set_sheet","set_material","add_rect","add_circle","corner_holes","select_all","clear_selection","move","duplicate","delete","assign_station","set_technology_reference","assign_tool","set_bevel","set_lead_in","set_lead_out","auto_order","set_view","fit_view","validate"]);
...
function parse(prompt,ctx={}){
 ...
 if(!raw)return{version:"cutai-ai-plan/0.7.7",source:"local",prompt:raw,summary:"Keine Eingabe",actions,warnings:["Bitte einen Arbeitsauftrag eingeben."],notes};
