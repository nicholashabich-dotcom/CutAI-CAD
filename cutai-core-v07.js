(function(root,factory){
  ...
  return{clamp,round,dist,near,normAngle,rad,deg,segStart,segEnd,reverseSegment,translateSegment,makeArc,arcAngles,arcSweep,angleOnArc,arcPoint,chainSegments,contourSamplePoints,contourBounds,contourArea,contourLength,pointInContour,contourCentroid,nestingDepth,autoClassify,nearestPointOnContour,translateContour,parseDxf,makeDxf,validateProject};
});
